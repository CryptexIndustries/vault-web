...
function PrismaAdapter(p) {
    return {
        ...
        async getSessionAndUser(sessionToken) {
            ...
            // NOTE: Had to clone the whole PrismaAdapter because of these two lines
            // We need to steal the account_id from the session table and set it on the user so we can access it in the session callback
            user.accountID = userAndSession.account_id;
            user.isRoot = userAndSession.account.root;
